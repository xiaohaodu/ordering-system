<template>
    ...
    <span style="width:100px;position: fixed;top: 60px;right: 0;z-index: 4;" :draggable="true"
        @dragstart="drag.dragEventStart" @dragend="drag.dragEventEnd">
        <QrCode :config="config"></QrCode>
    </span>
    <el-table :data="PendOrder" stripe style="width: 100%" :default-sort="{ prop: 'time', order: 'ascending' }">
        <el-table-column label="待处理订单" align="center">
            ...
            <el-table-column label="状态" align="center">
                <template #default="scope">
                    <el-button size="small" type="primary" @click="handleDelete(scope.$index, scope.row)">出菜</el-button>
                </template>
            </el-table-column>
        </el-table-column>
    </el-table>
...
const drag = {
    ...
    dragEventEnd: (dragEvent) => {
        ...
        dragEvent.target.style.left = dragEvent.target.offsetLeft + drag.left + 'px';
    }
